...
import { deleteAllTodoLists } from '../realm/databases/allSchemas';
    ...
    return (
        <View style={styles.container}>
            {hasAddButton && <TouchableOpacity style={styles.addButton} onPress={showAddTodoList}>
                <Image style={styles.addButtonImage} source={require('../kuvat/add-icon.png')} />
            </TouchableOpacity>}
            {hasDeleteAllButton && <TouchableOpacity style={styles.addButton} onPress={
                ...
                <Image style={styles.deleteButtonImage} source={require('../kuvat/delete-icon.png')}/>
            </TouchableOpacity>}     
        </View>
    );
};
